...
public class WeatherDataService {
    ...
    private static final String QUERY_FOR_CITY_WEATHER_B = "https://www.metaweather.com/api/location/";
    ...
    public void getCityID(String cityName, VolleyResponseListener volleyResponseListener) {
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                //This worked!! but it didn't return the id number of the MainActivity
...
//        return cityID;
    ...
    public void getCityForecastByID(String cityID, ForeCastByIDResponse foreCastByIDResponse){
        ...
        String url = QUERY_FOR_CITY_WEATHER_B + cityID;
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                // get each item in the array and assign it to whatever the guy wrote there
